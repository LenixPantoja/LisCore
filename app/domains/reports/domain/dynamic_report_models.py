...
class DynamicReport(Base):
    ...
    def __repr__(self) -> str:
        return f"<DynamicReport(id={self.dr_id}, name='{self.dr_name}')>"
...
class ReportParameter(Base):
    ...
    rp_report_id = Column(Integer, ForeignKey("DynamicReports.dr_id", ondelete="CASCADE"), nullable=False)
    ...
    def __repr__(self) -> str:
        return f"<ReportParameter(id={self.rp_id}, name='{self.rp_name}', type='{self.rp_type}')>"
